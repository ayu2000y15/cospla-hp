    ...
    <div class="form-area">
        ...
        <div class="photos-info">
            ...
            <div class="photo-upload-section">
                ...
                <form action="{{ route('admin.photos.upload') }}" method="POST" enctype="multipart/form-data" class="upload-form">
                    @csrf
                    <div class="file-upload-wrapper">
                        <input type="file" name="upfile[]" id="photo-upload" class="file-upload-input" multiple onchange="updateFileNames(this)">
                ...
                <div class="photo-grid">
                    ...
                    <div class="photo-item">
                        ...
                        <div class="photo-actions">
                            <form action="{{ route('admin.photos.update') }}" method="POST" class="change-form">
                                @csrf
                                @method('PUT')
                            ...
                            <form action="{{ route('admin.photos.delete') }}" method="POST" class="delete-form">
                                @csrf
                                @method('DELETE')
                                <input type="hidden" name="FILE_NAME" value="{{ $img->FILE_NAME }}">
